...
import com.example.pulltorefreshstaggeredgridviewdemo.R;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PullToRefreshStaggeredGridView refreshView = (PullToRefreshStaggeredGridView) findViewById(R.id.refresh_view);
		StaggeredGridView gridView = refreshView.getRefreshableView();
